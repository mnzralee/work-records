...
1. Create file: `DD-mon-YYYY.md` in correct `{Month}-{Year}/week-{NN}/` folder
2. Use 6-part structure: **Date** → **Title** → **Objective** → **Work Carried Out** → **Outcome** → **Activities Covered**
3. **Work Carried Out** = narrative paragraphs with bold headers (NOT bullets)
4. Include technical details: function names, line counts, technologies, quantitative measurements
5. Map work to 6-10 IIT activity codes from the official list
6. Write in professional, enterprise-grade technical language
7. **Privacy**: Generalize company-specific details, avoid exposing proprietary information

**Key principle:** Tell the story of your technical work with narrative flow, not just a list of what you did.

---

## Privacy & Confidentiality

**IMPORTANT:** When creating work records, write in general technical context without exposing:
- Company proprietary information or trade secrets
- Actual internal code names, project names, or client identifiers
- Sensitive infrastructure details (IP addresses, credentials, internal URLs)
- Confidential business data, financial figures, or strategic information
- Internal team member names or organizational structure details

**Instead:**
- Use generic technical terminology and architectural patterns
- Reference technologies and frameworks by their public names
- Describe problems and solutions in general engineering terms
- Focus on technical skills demonstrated rather than business specifics
- Maintain professional technical depth while protecting confidential information

The work records should demonstrate your technical capabilities and learning journey without compromising company privacy or intellectual property.
...
**Example domains:**
- **Blockchain:** Separating User vs Organization entities in chaincode models
- **Backend:** Refactoring monolithic service into microservices architecture
- **Frontend:** Migrating from Redux to React Context for state management
- **Database:** Normalizing denormalized tables to eliminate data redundancy
...
**Example domains:**
- **Blockchain:** Implementing multi-signature transaction approval workflow
- **Backend API:** Creating RESTful endpoints for user registration with OTP verification
- **Frontend:** Building multi-step wizard component with validation and state persistence
- **Data Processing:** Implementing event-driven projection system for read model updates
...
**Example domains:**
- **Blockchain:** Fixing non-deterministic timestamp usage causing peer consensus failures
- **Backend:** Resolving race condition in async event processing
- **Frontend:** Correcting form validation that allowed invalid data submission
- **Infrastructure:** Fixing DNS resolution preventing service discovery
...
**Example domains:**
- **Kubernetes:** Implementing StatefulSet with persistent volume claims
- **CI/CD:** Automating Docker image builds and multi-node deployments
- **Monitoring:** Setting up Prometheus metrics and Grafana dashboards
- **Networking:** Configuring ingress routing and TLS certificate management
...
**Example domains:**
- **Technical Guides:** Writing comprehensive lecture series on system architecture
- **API Documentation:** Creating OpenAPI specifications with request/response examples
- **Deployment Guides:** Documenting step-by-step deployment procedures with verification steps
- **Architecture Diagrams:** Creating system architecture visualizations with component interactions

### Pattern 6: Frontend UI/UX Development
**Typical commits:** Create components, implement responsive design, add animations

**Narrative focus:**
- Describe user experience goals and design requirements
- Detail component architecture and reusability patterns
- Explain state management and data flow
- Mention accessibility and responsive design considerations

**Example domains:**
- **React Components:** Building reusable form inputs with validation hooks
- **Responsive Design:** Implementing mobile-first layouts with Tailwind CSS breakpoints
- **User Flows:** Creating multi-step registration wizard with progress indicators
- **Accessibility:** Adding ARIA labels and keyboard navigation support

### Pattern 7: Database Design & Optimization
**Typical commits:** Schema migrations, index creation, query optimization

**Narrative focus:**
- Explain data modeling decisions and relationships
- Detail indexing strategy for query performance
- Describe migration approach and data integrity preservation
- Mention transaction handling and concurrency control

**Example domains:**
- **Schema Design:** Creating normalized database schema with proper foreign key constraints
- **Performance:** Adding composite indexes to optimize frequently-run queries
- **Migrations:** Implementing zero-downtime schema changes with backward compatibility
- **Data Integrity:** Enforcing constraints and validation at database level

---

## Common Work Themes

The work records document development across these technical areas (examples are generalized to protect company confidentiality):

- **Blockchain/Chaincode**: Smart contract development, consensus mechanisms, distributed ledger operations, on-chain governance
- **Backend Services**: Microservices architecture, API development, event-driven systems, CQRS patterns, message queuing
- **Frontend Development**: Component-based UI frameworks, state management, responsive design, progressive web apps
- **Database Systems**: Schema design, query optimization, data modeling, migration strategies, replication
- **Infrastructure**: Container orchestration, cloud deployments, configuration management, networking
- **DevOps**: CI/CD pipelines, deployment automation, monitoring and observability, infrastructure as code
- **Security**: Authentication systems, authorization frameworks, encryption, security protocols
- **Testing**: Unit testing, integration testing, end-to-end testing, test automation frameworks
- **Documentation**: Technical specifications, API documentation, architecture diagrams, deployment guides
- **Performance**: Code optimization, caching strategies, load testing, profiling and debugging
...
- **Maintain confidentiality**: Use general technical terms, avoid company-specific details
...
- **Exposing proprietary information**: Internal project names, client identifiers, sensitive infrastructure details
